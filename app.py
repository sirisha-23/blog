...
mydb=mysql.connector.connect(host='localhost',user='root',password='shirisha@23',db='blog')
with mysql.connector.connect(host='localhost',user='root',password='shirisha@23',db='blog'):
